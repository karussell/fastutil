...
public class Char2LongOpenCustomHashMap extends AbstractChar2LongMap implements java.io.Serializable, Cloneable, Hash {
 ...
 private class MapIterator {
  ...
  {
   final boolean used[] = Char2LongOpenCustomHashMap.this.used;
  ...
  public void remove() {
   ...
   if ( pos < -1 ) {
    ...
    Char2LongOpenCustomHashMap.this.remove( wrapped.getChar( - pos - 2 ) );
    last = -1;
    return;
   }
   size--;
 ...
 private final class MapEntrySet extends AbstractObjectSet<Char2LongMap.Entry > implements FastEntrySet {
  ...
  public boolean remove( final Object o ) {
   ...
   while( used[ pos ] ) {
    if ( ( strategy.equals( (key[ pos ]), (k) ) ) ) {
     Char2LongOpenCustomHashMap.this.remove( e.getKey() );
     return true;
    }
    pos = ( pos + 1 ) & mask;
   }
