...
public class Reference2ObjectOpenCustomHashMap <K,V> extends AbstractReference2ObjectMap <K,V> implements java.io.Serializable, Cloneable, Hash {
 ...
 private class MapIterator {
  ...
  {
   final boolean used[] = Reference2ObjectOpenCustomHashMap.this.used;
  ...
  public void remove() {
   ...
   if ( pos < -1 ) {
    ...
    Reference2ObjectOpenCustomHashMap.this.remove( wrapped.set( - pos - 2, null ) );
    last = -1;
    return;
   }
   size--;
 ...
 private final class MapEntrySet extends AbstractObjectSet<Reference2ObjectMap.Entry <K,V> > implements FastEntrySet <K,V> {
  ...
  public boolean remove( final Object o ) {
   ...
   while( used[ pos ] ) {
    if ( ( strategy.equals( (key[ pos ]), (K) (k) ) ) ) {
     Reference2ObjectOpenCustomHashMap.this.remove( e.getKey() );
     return true;
    }
    pos = ( pos + 1 ) & mask;
   }
