...
public class Long2DoubleOpenCustomHashMap extends AbstractLong2DoubleMap implements java.io.Serializable, Cloneable, Hash {
 ...
 private final class MapEntry implements Long2DoubleMap.Entry , Map.Entry<Long, Double> {
  ...
  public boolean equals( final Object o ) {
   ...
   return ( strategy.equals( (key[ index ]), (((e.getKey()).longValue())) ) ) && ( (value[ index ]) == (((e.getValue()).doubleValue())) );
  }
  public int hashCode() {
 ...
 private class MapIterator {
  ...
  {
   final boolean used[] = Long2DoubleOpenCustomHashMap.this.used;
  ...
  public void remove() {
   ...
   if ( pos < -1 ) {
    ...
    Long2DoubleOpenCustomHashMap.this.remove( wrapped.getLong( - pos - 2 ) );
    last = -1;
    return;
   }
   size--;
 ...
 private final class MapEntrySet extends AbstractObjectSet<Long2DoubleMap.Entry > implements FastEntrySet {
  ...
  public boolean remove( final Object o ) {
   ...
   while( used[ pos ] ) {
    if ( ( strategy.equals( (key[ pos ]), (k) ) ) ) {
     Long2DoubleOpenCustomHashMap.this.remove( e.getKey() );
     return true;
    }
    pos = ( pos + 1 ) & mask;
   }
