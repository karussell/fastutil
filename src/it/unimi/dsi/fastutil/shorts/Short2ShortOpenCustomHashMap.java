...
public class Short2ShortOpenCustomHashMap extends AbstractShort2ShortMap implements java.io.Serializable, Cloneable, Hash {
 ...
 private class MapIterator {
  ...
  {
   final boolean used[] = Short2ShortOpenCustomHashMap.this.used;
  ...
  public void remove() {
   ...
   if ( pos < -1 ) {
    ...
    Short2ShortOpenCustomHashMap.this.remove( wrapped.getShort( - pos - 2 ) );
    last = -1;
    return;
   }
   size--;
 ...
 private final class MapEntrySet extends AbstractObjectSet<Short2ShortMap.Entry > implements FastEntrySet {
  ...
  public boolean remove( final Object o ) {
   ...
   while( used[ pos ] ) {
    if ( ( strategy.equals( (key[ pos ]), (k) ) ) ) {
     Short2ShortOpenCustomHashMap.this.remove( e.getKey() );
     return true;
    }
    pos = ( pos + 1 ) & mask;
   }
