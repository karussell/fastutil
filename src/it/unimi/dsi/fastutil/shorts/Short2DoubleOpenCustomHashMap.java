...
public class Short2DoubleOpenCustomHashMap extends AbstractShort2DoubleMap implements java.io.Serializable, Cloneable, Hash {
 ...
 private final class MapEntry implements Short2DoubleMap.Entry , Map.Entry<Short, Double> {
  ...
  public boolean equals( final Object o ) {
   ...
   return ( strategy.equals( (key[ index ]), (((e.getKey()).shortValue())) ) ) && ( (value[ index ]) == (((e.getValue()).doubleValue())) );
  }
  public int hashCode() {
 ...
 private class MapIterator {
  ...
  {
   final boolean used[] = Short2DoubleOpenCustomHashMap.this.used;
  ...
  public void remove() {
   ...
   if ( pos < -1 ) {
    ...
    Short2DoubleOpenCustomHashMap.this.remove( wrapped.getShort( - pos - 2 ) );
    last = -1;
    return;
   }
   size--;
 ...
 private final class MapEntrySet extends AbstractObjectSet<Short2DoubleMap.Entry > implements FastEntrySet {
  ...
  public boolean remove( final Object o ) {
   ...
   while( used[ pos ] ) {
    if ( ( strategy.equals( (key[ pos ]), (k) ) ) ) {
     Short2DoubleOpenCustomHashMap.this.remove( e.getKey() );
     return true;
    }
    pos = ( pos + 1 ) & mask;
   }
