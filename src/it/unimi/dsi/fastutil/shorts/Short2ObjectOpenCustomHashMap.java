...
public class Short2ObjectOpenCustomHashMap <V> extends AbstractShort2ObjectMap <V> implements java.io.Serializable, Cloneable, Hash {
 ...
 private final class MapEntry implements Short2ObjectMap.Entry <V>, Map.Entry<Short, V> {
  ...
  public boolean equals( final Object o ) {
   ...
   return ( strategy.equals( (key[ index ]), (((e.getKey()).shortValue())) ) ) && ( (value[ index ]) == null ? ((e.getValue())) == null : (value[ index ]).equals((e.getValue())) );
  }
  public int hashCode() {
 ...
 private class MapIterator {
  ...
  {
   final boolean used[] = Short2ObjectOpenCustomHashMap.this.used;
  ...
  public void remove() {
   ...
   if ( pos < -1 ) {
    ...
    Short2ObjectOpenCustomHashMap.this.remove( wrapped.getShort( - pos - 2 ) );
    last = -1;
    return;
   }
   size--;
