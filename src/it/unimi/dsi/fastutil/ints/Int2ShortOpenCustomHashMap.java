...
public class Int2ShortOpenCustomHashMap extends AbstractInt2ShortMap implements java.io.Serializable, Cloneable, Hash {
 ...
 private class MapIterator {
  ...
  {
   final boolean used[] = Int2ShortOpenCustomHashMap.this.used;
  ...
  public void remove() {
   ...
   if ( pos < -1 ) {
    ...
    Int2ShortOpenCustomHashMap.this.remove( wrapped.getInt( - pos - 2 ) );
    last = -1;
    return;
   }
   size--;
 ...
 private class FastEntryIterator extends MapIterator implements ObjectIterator<Int2ShortMap.Entry > {
  final BasicEntry entry = new BasicEntry ( ((int)0), ((short)0) );
 ...
 private final class MapEntrySet extends AbstractObjectSet<Int2ShortMap.Entry > implements FastEntrySet {
  ...
  public boolean remove( final Object o ) {
   ...
   while( used[ pos ] ) {
    if ( ( strategy.equals( (key[ pos ]), (k) ) ) ) {
     Int2ShortOpenCustomHashMap.this.remove( e.getKey() );
     return true;
    }
    pos = ( pos + 1 ) & mask;
   }
