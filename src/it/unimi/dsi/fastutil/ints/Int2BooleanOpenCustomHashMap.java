...
public class Int2BooleanOpenCustomHashMap extends AbstractInt2BooleanMap implements java.io.Serializable, Cloneable, Hash {
 ...
 private class MapIterator {
  ...
  {
   final boolean used[] = Int2BooleanOpenCustomHashMap.this.used;
  ...
  public void remove() {
   ...
   if ( pos < -1 ) {
    ...
    Int2BooleanOpenCustomHashMap.this.remove( wrapped.getInt( - pos - 2 ) );
    last = -1;
    return;
   }
   size--;
 ...
 private class FastEntryIterator extends MapIterator implements ObjectIterator<Int2BooleanMap.Entry > {
  final BasicEntry entry = new BasicEntry ( ((int)0), (false) );
 ...
 private final class MapEntrySet extends AbstractObjectSet<Int2BooleanMap.Entry > implements FastEntrySet {
  ...
  public boolean remove( final Object o ) {
   ...
   while( used[ pos ] ) {
    if ( ( strategy.equals( (key[ pos ]), (k) ) ) ) {
     Int2BooleanOpenCustomHashMap.this.remove( e.getKey() );
     return true;
    }
    pos = ( pos + 1 ) & mask;
   }
