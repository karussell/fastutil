...
public class Byte2ObjectOpenCustomHashMap <V> extends AbstractByte2ObjectMap <V> implements java.io.Serializable, Cloneable, Hash {
 ...
 private final class MapEntry implements Byte2ObjectMap.Entry <V>, Map.Entry<Byte, V> {
  ...
  public boolean equals( final Object o ) {
   ...
   return ( strategy.equals( (key[ index ]), (((e.getKey()).byteValue())) ) ) && ( (value[ index ]) == null ? ((e.getValue())) == null : (value[ index ]).equals((e.getValue())) );
  }
  public int hashCode() {
 ...
 private class MapIterator {
  ...
  {
   final boolean used[] = Byte2ObjectOpenCustomHashMap.this.used;
  ...
  public void remove() {
   ...
   if ( pos < -1 ) {
    ...
    Byte2ObjectOpenCustomHashMap.this.remove( wrapped.getByte( - pos - 2 ) );
    last = -1;
    return;
   }
   size--;
 ...
 private final class MapEntrySet extends AbstractObjectSet<Byte2ObjectMap.Entry <V> > implements FastEntrySet <V> {
  ...
  public boolean remove( final Object o ) {
   ...
   while( used[ pos ] ) {
    if ( ( strategy.equals( (key[ pos ]), (k) ) ) ) {
     Byte2ObjectOpenCustomHashMap.this.remove( e.getKey() );
     return true;
    }
    pos = ( pos + 1 ) & mask;
   }
