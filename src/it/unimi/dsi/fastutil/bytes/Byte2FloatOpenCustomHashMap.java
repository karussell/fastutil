...
public class Byte2FloatOpenCustomHashMap extends AbstractByte2FloatMap implements java.io.Serializable, Cloneable, Hash {
 ...
 private final class MapEntry implements Byte2FloatMap.Entry , Map.Entry<Byte, Float> {
  ...
  public boolean equals( final Object o ) {
   ...
   return ( strategy.equals( (key[ index ]), (((e.getKey()).byteValue())) ) ) && ( (value[ index ]) == (((e.getValue()).floatValue())) );
  }
  public int hashCode() {
 ...
 private class MapIterator {
  ...
  {
   final boolean used[] = Byte2FloatOpenCustomHashMap.this.used;
  ...
  public void remove() {
   ...
   if ( pos < -1 ) {
    ...
    Byte2FloatOpenCustomHashMap.this.remove( wrapped.getByte( - pos - 2 ) );
    last = -1;
    return;
   }
   size--;
 ...
 private final class MapEntrySet extends AbstractObjectSet<Byte2FloatMap.Entry > implements FastEntrySet {
  ...
  public boolean remove( final Object o ) {
   ...
   while( used[ pos ] ) {
    if ( ( strategy.equals( (key[ pos ]), (k) ) ) ) {
     Byte2FloatOpenCustomHashMap.this.remove( e.getKey() );
     return true;
    }
    pos = ( pos + 1 ) & mask;
   }
