...
public class Byte2BooleanOpenCustomHashMap extends AbstractByte2BooleanMap implements java.io.Serializable, Cloneable, Hash {
 ...
 private class MapIterator {
  ...
  {
   final boolean used[] = Byte2BooleanOpenCustomHashMap.this.used;
  ...
  public void remove() {
   ...
   if ( pos < -1 ) {
    ...
    Byte2BooleanOpenCustomHashMap.this.remove( wrapped.getByte( - pos - 2 ) );
    last = -1;
    return;
   }
   size--;
 ...
 private final class MapEntrySet extends AbstractObjectSet<Byte2BooleanMap.Entry > implements FastEntrySet {
  ...
  public boolean remove( final Object o ) {
   ...
   while( used[ pos ] ) {
    if ( ( strategy.equals( (key[ pos ]), (k) ) ) ) {
     Byte2BooleanOpenCustomHashMap.this.remove( e.getKey() );
     return true;
    }
    pos = ( pos + 1 ) & mask;
   }
