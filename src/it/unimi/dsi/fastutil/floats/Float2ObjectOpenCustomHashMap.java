...
public class Float2ObjectOpenCustomHashMap <V> extends AbstractFloat2ObjectMap <V> implements java.io.Serializable, Cloneable, Hash {
 ...
 private final class MapEntry implements Float2ObjectMap.Entry <V>, Map.Entry<Float, V> {
  ...
  public boolean equals( final Object o ) {
   ...
   return ( strategy.equals( (key[ index ]), (((e.getKey()).floatValue())) ) ) && ( (value[ index ]) == null ? ((e.getValue())) == null : (value[ index ]).equals((e.getValue())) );
  }
  public int hashCode() {
 ...
 private class MapIterator {
  ...
  {
   final boolean used[] = Float2ObjectOpenCustomHashMap.this.used;
  ...
  public void remove() {
   ...
   if ( pos < -1 ) {
    ...
    Float2ObjectOpenCustomHashMap.this.remove( wrapped.getFloat( - pos - 2 ) );
    last = -1;
    return;
   }
   size--;
 ...
 private class FastEntryIterator extends MapIterator implements ObjectIterator<Float2ObjectMap.Entry <V> > {
  final BasicEntry <V> entry = new BasicEntry <V> ( ((float)0), (null) );
 ...
 private final class MapEntrySet extends AbstractObjectSet<Float2ObjectMap.Entry <V> > implements FastEntrySet <V> {
  ...
  public boolean contains( final Object o ) {
   ...
   // There's always an unused entry.
   while( used[ pos ] ) {
    if ( ( strategy.equals( (key[ pos ]), (k) ) ) ) return ( (value[ pos ]) == null ? ((e.getValue())) == null : (value[ pos ]).equals((e.getValue())) );
    pos = ( pos + 1 ) & mask;
   }
   return false;
  }
  ...
  public boolean remove( final Object o ) {
   ...
   while( used[ pos ] ) {
    if ( ( strategy.equals( (key[ pos ]), (k) ) ) ) {
     Float2ObjectOpenCustomHashMap.this.remove( e.getKey() );
     return true;
    }
    pos = ( pos + 1 ) & mask;
   }
