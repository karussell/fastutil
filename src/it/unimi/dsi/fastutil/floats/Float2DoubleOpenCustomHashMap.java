...
public class Float2DoubleOpenCustomHashMap extends AbstractFloat2DoubleMap implements java.io.Serializable, Cloneable, Hash {
 ...
 private final class MapEntry implements Float2DoubleMap.Entry , Map.Entry<Float, Double> {
  ...
  public boolean equals( final Object o ) {
   ...
   return ( strategy.equals( (key[ index ]), (((e.getKey()).floatValue())) ) ) && ( (value[ index ]) == (((e.getValue()).doubleValue())) );
  }
  public int hashCode() {
 ...
 private class MapIterator {
  ...
  {
   final boolean used[] = Float2DoubleOpenCustomHashMap.this.used;
  ...
  public void remove() {
   ...
   if ( pos < -1 ) {
    ...
    Float2DoubleOpenCustomHashMap.this.remove( wrapped.getFloat( - pos - 2 ) );
    last = -1;
    return;
   }
   size--;
 ...
 private class FastEntryIterator extends MapIterator implements ObjectIterator<Float2DoubleMap.Entry > {
  final BasicEntry entry = new BasicEntry ( ((float)0), (0) );
 ...
 private final class MapEntrySet extends AbstractObjectSet<Float2DoubleMap.Entry > implements FastEntrySet {
  ...
  public boolean contains( final Object o ) {
   ...
   // There's always an unused entry.
   while( used[ pos ] ) {
    if ( ( strategy.equals( (key[ pos ]), (k) ) ) ) return ( (value[ pos ]) == (((e.getValue()).doubleValue())) );
    pos = ( pos + 1 ) & mask;
   }
   return false;
  }
  ...
  public boolean remove( final Object o ) {
   ...
   while( used[ pos ] ) {
    if ( ( strategy.equals( (key[ pos ]), (k) ) ) ) {
     Float2DoubleOpenCustomHashMap.this.remove( e.getKey() );
     return true;
    }
    pos = ( pos + 1 ) & mask;
   }
